...
portable_serial_weight_hints() {
  cat <<'EOF'
tests/fm-afk-inject-e2e.test.sh 34370
tests/fm-afk-pi-herdr-return-e2e.test.sh 72
tests/fm-afk-return.test.sh 1450
tests/fm-ask-user-authority.test.sh 94
tests/fm-backend-cmux-smoke.test.sh 32
tests/fm-backend-cmux.test.sh 3497
tests/fm-backend-herdr-focus-flash-e2e.test.sh 22
tests/fm-backend-orca.test.sh 15728
tests/fm-backend-tmux-smoke.test.sh 326
tests/fm-backend-zellij-smoke.test.sh 18
tests/fm-backend-zellij.test.sh 8929
tests/fm-backend.test.sh 17670
tests/fm-backlog-handoff.test.sh 44298
tests/fm-bearings-board-render.test.sh 1409
tests/fm-bearings-board.test.sh 3982
tests/fm-bearings-snapshot.test.sh 73633
tests/fm-bootstrap-network-parallel.test.sh 7961
tests/fm-bootstrap.test.sh 36092
tests/fm-branch-supervision.test.sh 5833
tests/fm-busy-adapter-wiring.test.sh 14946
tests/fm-busy-state.test.sh 2890
tests/fm-calm-pi-extension.test.sh 191
tests/fm-classify-corr-token.test.sh 31268
tests/fm-classify-decision-key.test.sh 1005
tests/fm-claude-stop-autoarm-live-e2e.test.sh 18
tests/fm-claude-stop-autoarm.test.sh 60641
...
tests/fm-control-relaunch.test.sh 60445
tests/fm-control.test.sh 37413
tests/fm-cursor-harness.test.sh 30074
tests/fm-cursor-primary-live-e2e.test.sh 19
tests/fm-cursor-primary.test.sh 53942
tests/fm-daemon.test.sh 19471
tests/fm-documentation-audiences.test.sh 716
tests/fm-fleet-snapshot-view.test.sh 7167
tests/fm-fleet-sync.test.sh 36040
tests/fm-gate-refuse.test.sh 4435
tests/fm-gitignore-config.test.sh 49
tests/fm-gotmp.test.sh 721
tests/fm-grok-continuity-live-e2e.test.sh 19
tests/fm-grok-stop-live-e2e.test.sh 16
tests/fm-guard-stale-banner.test.sh 9497
tests/fm-harness-liveness-drift-live-e2e.test.sh 21
tests/fm-herdr-session-cleanup.test.sh 5555
tests/fm-herdr-submit-confirm-live-e2e.test.sh 22
tests/fm-herdr-version-floor-live-e2e.test.sh 21
tests/fm-inactive-reconcile.test.sh 41204
tests/fm-kimi-harness.test.sh 14903
tests/fm-lint-workflows.test.sh 781
tests/fm-muse-harness.test.sh 43430
tests/fm-muse-signals-live-e2e.test.sh 22
tests/fm-no-mistakes-required.test.sh 195
tests/fm-on.test.sh 10801
tests/fm-opencode-primary-live-e2e.test.sh 20
tests/fm-operational-input.test.sh 221
tests/fm-peek-remote.test.sh 909
tests/fm-pending-reply.test.sh 22442
tests/fm-pi-branch-extension.test.sh 21851
tests/fm-pi-branch-live-e2e.test.sh 17
tests/fm-pi-primary-live-e2e.test.sh 20
tests/fm-pi-watch-extension.test.sh 40459
tests/fm-pr-check-security.test.sh 269682
tests/fm-procevent-when.test.sh 14110
tests/fm-procevent.test.sh 61959
tests/fm-project-origin.test.sh 127
tests/fm-public-followup.test.sh 181501
tests/fm-quota-array-dispatch-live-e2e.test.sh 19
tests/fm-remote-backlog-handoff.test.sh 95282
tests/fm-remote-doctor.test.sh 4887
tests/fm-remote-entrypoint.test.sh 87
tests/fm-remote-job-orphan-reap.test.sh 2926
tests/fm-remote-job.test.sh 58689
tests/fm-remote-reply.test.sh 99716
tests/fm-remote-secondmate-lifecycle-e2e.test.sh 194502
tests/fm-remote-secondmate-parent-binding.test.sh 13412
tests/fm-remote-secondmate-trace-context.test.sh 48612
tests/fm-remote-transport-lanes.test.sh 62323
tests/fm-secondmate-harness.test.sh 129534
tests/fm-secondmate-lifecycle-e2e.test.sh 7451
tests/fm-secondmate-liveness.test.sh 16276
tests/fm-secondmate-reconcile.test.sh 60044
tests/fm-secondmate-safety.test.sh 49164
tests/fm-secondmate-sync.test.sh 15012
tests/fm-send-inbox-doorbell-live-e2e.test.sh 21
tests/fm-send-inbox.test.sh 37273
tests/fm-send-remote-delivery.test.sh 26302
tests/fm-send-resolve-key.test.sh 16375
tests/fm-send-secondmate-marker-herdr-e2e.test.sh 70
tests/fm-send-secondmate-marker.test.sh 5763
tests/fm-session-lock-ancestry.test.sh 1160
tests/fm-session-start.test.sh 146049
tests/fm-sessionstart-hook-live-e2e.test.sh 20
tests/fm-sessionstart-instruction-refresh-live-e2e.test.sh 19
tests/fm-sessionstart-nudge.test.sh 28656
tests/fm-shared-captain-inheritance.test.sh 5604
tests/fm-spawn-dispatch-profile.test.sh 58504
tests/fm-spawn-pool-base-freshen.test.sh 29931
tests/fm-spawn-worktree-settle.test.sh 4865
tests/fm-startup-memory-budget.test.sh 6167
tests/fm-startup-network.test.sh 54329
tests/fm-stow-cascade.test.sh 3029
tests/fm-subagent-pretool-check.test.sh 972
tests/fm-supervision-events.test.sh 514
tests/fm-tangle-guard.test.sh 8232
tests/fm-task-delivery.test.sh 2247
tests/fm-task-inbox.test.sh 24460
tests/fm-teardown-endpoint-safety.test.sh 3321
tests/fm-teardown.test.sh 86477
tests/fm-test-fixture-cleanup.test.sh 507
tests/fm-test-isolation-proof.test.sh 489
tests/fm-tmux-agent-liveness.test.sh 1512
tests/fm-tool-update-check.test.sh 12886
tests/fm-trace-context-lib.test.sh 200
tests/fm-trace-context-spawn.test.sh 34927
tests/fm-turnend-guard.test.sh 19906
tests/fm-update.test.sh 4847
tests/fm-vendor-auth-probe.test.sh 43241
tests/fm-voice-relay.test.sh 28559
tests/fm-wake-daemon-lifecycle-e2e.test.sh 6434
tests/fm-wake-drain-open-decisions-cursor.test.sh 17730
tests/fm-wake-drain-open-decisions.test.sh 5225
tests/fm-wake-drain-unread-status.test.sh 9910
tests/fm-wake-queue.test.sh 54861
tests/fm-watch-arm.test.sh 70922
tests/fm-watch-checkpoint.test.sh 5450
tests/fm-watch-recovery-loop.test.sh 58839
tests/fm-watch-triage.test.sh 152390
tests/fm-watcher-lock.test.sh 70896
EOF
}
